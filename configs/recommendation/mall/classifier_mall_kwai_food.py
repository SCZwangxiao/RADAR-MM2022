...
model = dict(
    ...
    cls_head=dict(
        ...
        cluster_size=32,
        max_neighbors=4,
        graph_path='./data/kwai/tag_parents_food.json',
        label_map_path='./data/kwai/label_map_kwai_food.txt',
        dropout_ratio=0.4),
...
ann_file_train = './data/kwai/kwai_food_video_train_list.txt'
ann_file_val = './data/kwai/kwai_food_video_val_list.txt'
ann_file_test = './data/kwai/kwai_food_video_test_list.txt'
