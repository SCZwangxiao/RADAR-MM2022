...
data = dict(
    ...
    workers_per_gpu=2, # Watch out for OOM, at least 30GB*2 each worker
    train=dict(
        type=dataset_type,
        vertical=vertical,
        split='train',
...
# optimizer
optimizer = dict(
    type='Adam', lr=0.01, weight_decay=0.0001)  # this lr is used for 1 gpus
...
work_dir = './work_dirs/devise_bert_ft_kwai_food/'