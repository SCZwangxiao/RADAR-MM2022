...
from multimodal.datasets import build_dataloader, build_dataset
from multimodal.models import build_model
from multimodal.utils import register_module_hooks
...
try:
    ...
    from multimodal.apis import multi_gpu_test, single_gpu_test


def parse_args():
    parser = argparse.ArgumentParser(
        description='IlearnMultimodal test (and eval) a model')
